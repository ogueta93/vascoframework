...
class PdfReader
{
	...
	/** 
	 * Gets data text from a pdf file
	 * 
	 * @return mixed $data
	*/
	...
	/**
	 * Decodes input on flate
	 * 
	 * @param string $input
	 * @return mixed $data
	 */
	protected function decodeFlate($input) 
	{
	...
	/**
	 * Gets char transformation by reference
	 * 
	...
	/**
	 * Gets text document using transformation
	 * 
	 * @param array $texts
	 * @param array $transformations
